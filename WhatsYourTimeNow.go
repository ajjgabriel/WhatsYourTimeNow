...
func root(w http.ResponseWriter, r *http.Request) {
	...
	timeEvent.UTCMinus1 = time.Now().Add(-1000000000*60*60)
	timeEvent.UTCMinus2 = time.Now().Add(-1000000000*60*60*2)
	timeEvent.UTCMinus230 = time.Now().Add(-1000000000*60*60*2).Add(-1000000000*60*30)
	timeEvent.UTCMinus3 = time.Now().Add(-1000000000*60*60*3)
	timeEvent.UTCMinus330 = time.Now().Add(-1000000000*60*60*3).Add(-1000000000*60*30)
	timeEvent.UTCMinus4 = time.Now().Add(-1000000000*60*60*4)
	timeEvent.UTCMinus430 = time.Now().Add(-1000000000*60*60*4).Add(-1000000000*60*30)
	timeEvent.UTCMinus5 = time.Now().Add(-1000000000*60*60*5)
	timeEvent.UTCMinus6 = time.Now().Add(-1000000000*60*60*6)
	timeEvent.UTCMinus7 = time.Now().Add(-1000000000*60*60*7)
	timeEvent.UTCMinus8 = time.Now().Add(-1000000000*60*60*8)
	timeEvent.UTCMinus9 = time.Now().Add(-1000000000*60*60*9)
	timeEvent.UTCMinus930 = time.Now().Add(-1000000000*60*60*9).Add(-1000000000*60*30)
	timeEvent.UTCMinus10 = time.Now().Add(-1000000000*60*60*10)
	timeEvent.UTCMinus11 = time.Now().Add(-1000000000*60*60*11)
	timeEvent.UTCMinus12 = time.Now().Add(-1000000000*60*60*12)
	timeEvent.UTC = time.Now()
	timeEvent.UTCPlus1 = time.Now().Add(1000000000*60*60)
	timeEvent.UTCPlus2 = time.Now().Add(1000000000*60*60*2)
	timeEvent.UTCPlus3 = time.Now().Add(1000000000*60*60*3)
	timeEvent.UTCPlus330 = time.Now().Add(1000000000*60*60*3).Add(1000000000*60*30)
	timeEvent.UTCPlus4 = time.Now().Add(1000000000*60*60*4)
	timeEvent.UTCPlus430 = time.Now().Add(1000000000*60*60*4).Add(1000000000*60*30)
	timeEvent.UTCPlus5 = time.Now().Add(1000000000*60*60*5)
	timeEvent.UTCPlus530 = time.Now().Add(1000000000*60*60*5).Add(1000000000*60*30)
	timeEvent.UTCPlus545 = time.Now().Add(1000000000*60*60*5).Add(1000000000*60*45)
	timeEvent.UTCPlus6 = time.Now().Add(1000000000*60*60*6)
	timeEvent.UTCPlus630 = time.Now().Add(1000000000*60*60*6).Add(1000000000*60*30)
	timeEvent.UTCPlus7 = time.Now().Add(1000000000*60*60*7)
	timeEvent.UTCPlus8 = time.Now().Add(1000000000*60*60*8)
	timeEvent.UTCPlus9 = time.Now().Add(1000000000*60*60*9)
	timeEvent.UTCPlus930 = time.Now().Add(1000000000*60*60*9).Add(1000000000*60*30)
	timeEvent.UTCPlus10 = time.Now().Add(1000000000*60*60*10)
	timeEvent.UTCPlus1030 = time.Now().Add(1000000000*60*60*10).Add(1000000000*60*30)
	timeEvent.UTCPlus11 = time.Now().Add(1000000000*60*60*11)
	timeEvent.UTCPlus1130 = time.Now().Add(1000000000*60*60*11).Add(1000000000*60*30)
	timeEvent.UTCPlus12 = time.Now().Add(1000000000*60*60*12)
	timeEvent.UTCPlus1245 = time.Now().Add(1000000000*60*60*12).Add(1000000000*60*45)
	timeEvent.UTCPlus13 = time.Now().Add(1000000000*60*60*13)
	timeEvent.UTCPlus1345 = time.Now().Add(1000000000*60*60*13).Add(1000000000*60*45)
	timeEvent.UTCPlus14 = time.Now().Add(1000000000*60*60*14)
	whatsYourTimeNowForm.Execute(w, timeEvent)
}

var whatsYourTimeNowForm = template.Must(template.New("root").Parse(whatsYourTimeNowHTML))
const whatsYourTimeNowHTML = `
<html>
  <body>
    <div align="center">
